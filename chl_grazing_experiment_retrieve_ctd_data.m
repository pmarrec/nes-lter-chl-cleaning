%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Matlab script for retrieving the DateTime, Latitude and Longitude of
...
for n1=2:numel(list)%skip ar66 because the data are not yet in REST-API
